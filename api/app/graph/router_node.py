...
- A (구조형): 가격·차종·연식·색상·지역·주행거리·연료 등 명시적 조건으로 매물을 거르는 질의.
    예) "3천만원 이하 흰색 SUV", "2020년 이후 제네시스", "10만km 미만 디젤", "서울 경차"
- B (질적·의미형): 정확한 조건 대신 용도·느낌·추천을 묻는 질의(조건이 흐릿한 매물 질의 포함).
    예) "패밀리카로 무난한 거", "초보운전자에게 좋은 차", "연비 좋은 전기차 추천", "가성비 좋은 차"
- C (매물 무관): 중고차 매물 검색과 관계없는 잡담·상식·다른 주제·인사.
    예) "오늘 날씨 어때?", "파이썬 코드 짜줘", "안녕", "1+1은?"

규칙:
- route 는 반드시 "A", "B", "C" 중 하나.
- 차에 관한 질의인데 조건이 흐릿하면(애매하면) C가 아니라 B로 분류한다(빈손보다 추천).
- 정말로 중고차 매물 검색과 무관할 때만 C로 분류한다."""
