...
### 123. 무인 루프 정책변경 2건이 "적용은 됐으나 실동작은 미관측"이다 — 다음 에픽에서 측정 (2026-07-22 Epic 10 회고 등재, 🟡 검증갭)
...
- **해소:** 미해소(다음 에픽 관측에서 판단). 상세 경위 = `_bmad-output/implementation-artifacts/epic-10-retro-2026-07-22.md` §3.4.
