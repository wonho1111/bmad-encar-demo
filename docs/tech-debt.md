...
### 114. 카드 옵션 칩이 좁은 폭에서 "외 N" 축약 없이 잘릴 수 있다 (2026-07-22 Story 10.3 코드리뷰 defer, 🟢 품질)
...
- **해소:** 10.7에서 실측 후 판단(축약 필 도입 또는 현행 유지 근거 등재).

### 115. `sprint-status.yaml`의 `last_updated`가 산문·백틱·괄호를 담은 거대 단일 인용부호 스칼라다 — YAML 파싱 지뢰 (2026-07-22 Story 10.3 후속 리뷰 defer, 🟢 품질)
