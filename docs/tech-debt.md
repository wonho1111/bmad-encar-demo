...
| 🟡 조건부 | **19** | 재오픈 차단(#9) · 타입(#12) · **GRANT(#18 — Epic 9)** · 관리자 운영 실사용 미확인(#19) · 거래일 `sold_at`(#20) · **게이트 구조적 대가 3종(#22~24 — Epic 13)** · psycopg 버전핀(#25) · 폐기토큰 401(#26) · **시드 멱등 delete(#27 — Epic 9·10)** · **storage.objects 인증 DELETE/LIST 403(#51 — Epic 9.3, 원인 미상)** · **앱 사진 업로더 계획 공백(#52 — Epic 16)** · **수정 중 sold 전환 관통(#54)** · **서명 URL 만료 미복구(#55)** · **동시 편집 10장 초과 고아(#56)** · *(📅 예약: #6 멱등키→12-1 · #7 폴링배너→12-4 · #11 옵션쉼표→10-3 · **#54→9-7 · #55→9-5 · #56→Epic 9 회고**)* |
